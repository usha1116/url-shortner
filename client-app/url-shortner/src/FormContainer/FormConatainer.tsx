  ...
  return (
    <div className='container mx-auto p-2'>
      <div className='bg-banner my-8 rounded-xl bg-cover bg-center'>
        ...
        <h2 className='text-white text-3xl font-bold text-center pb-4'>URL Shortener</h2>
        ...
        <p className='text-white text-center pb-4 text-sm font-extralight '>
          free tool to shorten a URL or reduce link ,
           Use our Shortener to create a shortened & neat link making 
          it easy to use</p>
          <form onSubmit={handleSubmit}>
            <div className='flex'>
              <div className="relative w-full">
                ...
                className='block w-full p-4 ps-32 
                text-sm text-gray-900 border
                 border-gray-300 rounded-lg
                  bg-white focus:ring-blue-500
                   ...
                   />
                   <button type="submit" 
                   className=' absolute top-0 end-0 p-2.5 text-sm font-medium h-full bg-blue-700 text-white rounded-lg border border-blue-700 focus:ring-4 focus:outline-none'>Shorten URL
